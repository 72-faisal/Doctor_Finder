...
<html lang="zxx">
<head>
<title>Health Plus a Medical Category Bootstrap Responsive
		...
		<div class="header_agileinfo">
			<div class="w3_agileits_header_text">
				<ul class="top_agile_w3l_info_icons">
					<li><i class="fa fa-home" aria-hidden="true"></i>12K
						Street,New York City.</li>
					<li class="second"><i class="fa fa-phone" aria-hidden="true"></i>(+000)
						123 456 87</li>

					<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a
						href="mailto:maria@example.com">info@example.com</a></li>
				</ul>
					...
					<nav class="menu menu--sebastian">
						<ul id="m_nav_list" class="m_nav menu__list">
							...
							<li class="m_nav_item menu__item" id="moble_nav_item_4"><a
								href="appointment.jsp" class="menu__link">Appointment </a></li>
		...
		<div class="container">
				...
				<div class="col-md-4 contact-grid ">
					<div class="contact-grid1 agileits-w3layouts">
						...
						<div class="con-w3l-info">
							<h4>Address</h4>
							<p>
								12K Street<span>New York City.</span>
							</p>
						</div>
						<div class="clearfix"></div>
					</div>
				...
				<div class="col-md-4 contact-grid">
					<div class="contact-grid2 w3">
						...
						<div class="con-w3l-info">
							<h4>Call Us</h4>
							<p>
								+1234 567 890<span>+1234 567 890</span>
							</p>
						</div>
						<div class="clearfix"></div>
					</div>
			...
			<section class="contact py-lg-4 py-md-3 py-sm-3 py-3">
				<div class="container py-lg-5 py-md-4 py-sm-4 py-3">
					<h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Doctor
						Register</h3>
							...
							<div class=" agile-wls-contact-mid">
								...
								<div class="form-group contact-forms">
									<input type="email" class="form-control"
										placeholder="Enter Email" name="demail">
								</div>
								<div class="form-group contact-forms">
									<input type="password" class="form-control"
										placeholder="Enter Password" name="dpassword">
								</div>
								<div class="form-group contact-forms">
									<input type="text" class="form-control"
										placeholder="Enter Home Address" name="dhaddress">
								</div>
								<div class="form-group contact-forms">
									<input type="text" class="form-control"
										placeholder="Enter Clinic Address" name="dcaddress">
								</div>
								<div class="form-group contact-forms">
									<input type="text" class="form-control"
										placeholder="Enter Speciality" name="dspeciality">
								</div>
								<div class="form-group contact-forms">
									<input type="text" class="form-control"
										placeholder="Enter Contact no" name="dcontact">
								</div>
								<button type="submit" name="action" value="upload"
									class="btn btn-block sent-butnn">Register</button>
							</div>
						</form>
					</div>
				</div>
		...
		<div class="container">
			...
			<div class="agile_footer_copy">
				<div class="w3agile_footer_grids">
					...
					<div class="col-md-4 w3agile_footer_grid">
						<h3>Contact Info</h3>
						<ul>
							<li><i class="fa fa-map-marker" aria-hidden="true"></i>1234k
								Avenue, 4th block, <span>New York City.</span></li>
							<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a
								href="mailto:info@example.com">info@example.com</a></li>
							<li><i class="fa fa-phone" aria-hidden="true"></i>+1234 567
								567</li>
						</ul>
					</div>
					<div class="col-md-4 w3agile_footer_grid w3agile_footer_grid1">
						...
						<ul>
							<li><span class="fa fa-long-arrow-right" aria-hidden="true"></span><a
								href="gallery.jsp">Department</a></li>
							<li><span class="fa fa-long-arrow-right" aria-hidden="true"></span><a
			...
			<div class="w3_agileits_copy_right_social">
				<div class="col-md-6 agileits_w3layouts_copy_right">
					<p>
						&copy; 2017 Health Plus. All rights reserved | Design by <a
