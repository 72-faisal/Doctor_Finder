...
<body>
	...
	<div class="department-box">
		<div class="row">
		<%List<Doctordata> list=Doctordao.getcardiologist();  %>
		<%for(Doctordata d:list){ %>
					
			<div class="col-md-4 department">
				<div class="overlay">
					<img src="<%=d.getImage() %>" alt=" " class="img-responsive" />
					...
					<div class="btn-group" role="group">
						<a href="View_details_cardio.jsp?did=<%=d.getDid()%>" class="btn btn-primary" >View Details</a>
