...
public class Appointmentdata {
	...
	public String toString() {
		return "Appointmentdata [Appointment_id=" + Appointment_id + ", Appointment_name=" + Appointment_name
				+ ", Appointment_email=" + Appointment_email + ", Appointment_symptoms=" + Appointment_symptoms
				+ ", Appointment_date=" + Appointment_date + ", Appointment_department=" + Appointment_department
				+ ", Appointment_gender=" + Appointment_gender + ", Appointment_time=" + Appointment_time
				+ ", Appointment_number=" + Appointment_number + "]";
	}
