...
<!-- //banner1 -->
	<div class="banner-bottom" id="about">
		<div class="container">
			<h2 class="w3_heade_tittle_agile">Doctor Profile</h2>
      ...
      <section class="contact py-lg-4 py-md-3 py-sm-3 py-3">
         <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Doctor Profile</h3>
            <div class="contact-list-grid">
               <form action="DoctorController" method="post">
                  <div class=" agile-wls-contact-mid">
                  <div class="form-group contact-forms">
                        <input type="hidden" class="form-control" placeholder="Name" name="did" value="<%=d.getDid()%>">
                     </div>
                     <div class="form-group contact-forms">
                        <input type="text" class="form-control" placeholder="Name" name="dname" value="<%=d.getDname()%>">
                     </div>
                     <div class="form-group contact-forms">
                        <input type="email" class="form-control" placeholder="Enter Email" name="demail" value="<%= d.getDemail()%>">
                     </div>
                     <div class="form-group contact-forms">
                        <input type="text" class="form-control" placeholder="Enter Address" name="dhaddress" value="<%=d.getDhaddress()%>">
                     </div>
                     <div class="form-group contact-forms">
                        <input type="text" class="form-control" placeholder="Enter Address" name="dcaddress" value="<%=d.getDcaddress()%>">
                     </div>
                     <div class="form-group contact-forms">
                        <input type="text" class="form-control" placeholder="Enter Speciality" name="dspeciality" value="<%=d.getDspeciality()%>">
                     </div>
                     <div class="form-group contact-forms">
                        <input type="text" class="form-control" placeholder="Enter Contact no" name="dcontact" value="<%=d.getDContact() %>">
                     </div>
