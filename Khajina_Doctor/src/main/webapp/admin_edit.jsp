                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <%Doctordata d = Doctordao.getDoctorByiD(did); %>
                                <form class="cmxform form-horizontal " id="commentForm" method="post" action="DoctorController" novalidate="novalidate">
                                    <div class="form-group ">
                                        <!-- <label for="cname" class="control-label col-lg-3">Id</label> -->
                                        <div class="col-lg-6">
                                            <input type="hidden" class="form-control"  name="did"   value="<%=d.getDid()%>">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">Name</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control"  name="dname" type="text" value="<%=d.getDname()%>">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="cemail" class="control-label col-lg-3">Contact</label>
                                        <div class="col-lg-6">
                                            <input class="form-control "  type="text" name="dcontact" value="<%=d.getDContact()%>">
                                        </div>
                                    </div>
                                     <div class="form-group ">
                                        <label for="cemail" class="control-label col-lg-3">Address</label>
                                        <div class="col-lg-6">
                                            <input class="form-control "  type="text" name="dcaddress" value="<%=d.getDcaddress()%>">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="curl" class="control-label col-lg-3">Email</label>
                                        <div class="col-lg-6">
                                            <input class="form-control "  type="email" name="demail" value="<%=d.getDemail()%>">
                                        </div>
                                    </div>
                                    <div class="form-group">
