...
<!-- //banner1 -->
	<div class="banner-bottom" id="about">
		<div class="container">
			<h2 class="w3_heade_tittle_agile">Patient Registration</h2>
      ...
      <section class="contact py-lg-4 py-md-3 py-sm-3 py-3">
         <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Patient Register</h3>
               ...
               <form action="PatientController" method="post">
                  <div class=" agile-wls-contact-mid">
                     ...
                     <div class="form-group contact-forms">
                      ...
                      <div class="form-group contact-forms">
                        <input type="password" class="form-control" placeholder="Eneter Password" name="password">
                     </div>
                      <div class="form-group contact-forms">
