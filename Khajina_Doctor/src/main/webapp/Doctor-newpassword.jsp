		...
		<div class="header-bottom">
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					...
					<ul id="m_nav_list" class="m_nav menu__list">
						...
						<li class="m_nav_item menu__item" id="moble_nav_item_3 dropdown"> <a href="#" class="menu__link dropdown-toggle" data-toggle="dropdown">Registration  <b class="caret"></b></a> 
...
<!-- //banner1 -->
	<div class="banner-bottom" id="about">
		<div class="container">
			<h2 class="w3_heade_tittle_agile">Patient Login</h2>
             ...
             <form action="PatientController" method="post">
                  <div class=" agile-wls-contact-mid">
                     <div class="form-group contact-forms">
                        ...
                        <input type="password" class="form-control" name="dnp" placeholder="New Password">
                        <input type="password" class="form-control" name="dcnp" placeholder="Confirm New Password">
                     </div>
