...
<body>
	...
	<div class="banner-bottom" id="about">
		<div class="container">
			<h2 class="w3_heade_tittle_agile">Doctor Login</h2>
							...
							<form action="DoctorController" method="post">
								<div class=" agile-wls-contact-mid">
									...
									<button type="submit" name="action" value="login"
										class="btn btn-block sent-butnn">Login</button>
								</div>

							</form>
							<h5 class="text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">
								<a href="Doctor-forgetpassword.jsp">Forget Password?></a>
							</h5>
						</div>
					</div>
					<!--//contact-map -->
