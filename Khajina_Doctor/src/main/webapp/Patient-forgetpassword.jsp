...
<body>
	...
	<div class="banner-bottom" id="about">
		<div class="container">
			<h2 class="w3_heade_tittle_agile">Forget Password</h2>
				...
				<div class="col-md-4 contact-grid ">
					<div class="contact-grid1 agileits-w3layouts">
						...
						<div class="con-w3l-info">
							<h4>Address</h4>
							<p>
								Near Kankariya,<span>Ahmedabad.</span>
							</p>
						</div>
						<div class="clearfix"></div>
					</div>
				...
				<div class="col-md-4 contact-grid">
					<div class="contact-grid3 w3l">
						...
						<div class="con-w3l-info">
							<h4>Email</h4>
							<p>
								<a href="mailto:info@example.com">Khajinadoc@gmail.com</a>
					...
					<div class="contact-list-grid">
						...
						<form action="PatientController" method="post">
							<div class=" agile-wls-contact-mid">
								...
								<button type="submit" name="action" value="get otp"
									class="btn btn-block sent-butnn">GET OTP</button>
							</div>
			...
			<div class="agile_footer_copy">
				<div class="w3agile_footer_grids">
					<div class="col-md-4 w3agile_footer_grid">
						<h3>About Us</h3>
						<p>
							"Welcome to KhajinDoc, the leading doctor finder app for finding
							top-quality healthcare providers near you. Our app is designed to
							make it easy for you to find and book appointments with the best
							doctors, surgeons, and specialists in your area.</span>
						</p>
					</div>
					<div class="col-md-4 w3agile_footer_grid">
						<h3>Contact Info</h3>
