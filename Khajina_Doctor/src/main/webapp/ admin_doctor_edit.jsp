                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class=" form">
                            <%String dspeciality = request.getParameter("dspeciality"); %>
                            <%Doctordata d = Doctordao.cardiologistdrbyspeciality(dspeciality); %>
                                <form class="cmxform form-horizontal " id="commentForm" method="post" action="SellerController" novalidate="novalidate">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="id"  type="text" value="<%=d.getDid()%>">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">Name</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="name" type="text" value="<%=d.getDname()%>">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="cemail" class="control-label col-lg-3">Contact</label>
                                        <div class="col-lg-6">
                                            <input class="form-control " id="cemail" type="text" name="contact" value="<%=d.getDContact()%>">
                                        </div>
                                    </div>
                                     <div class="form-group ">
                                        <label for="cemail" class="control-label col-lg-3">Address</label>
                                        <div class="col-lg-6">
                                            <input class="form-control " id="cemail" type="text" name="address" value="<%=d.getDcaddress()%>">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="curl" class="control-label col-lg-3">Email</label>
                                        <div class="col-lg-6">
                                            <input class="form-control " id="curl" type="email" name="email" value="<%=d.getDemail()%>">
                                        </div>
                                    </div>
                                    <div class="form-group">
